...
(12, "Lumen"),
(13, "Gadir"),
(14,"Penguin Random House Grupo Editorial Argentina 2019"),
(15,"Siglo XXI Editores 2019");
...
INSERT INTO authors (id, name, bioAuthor, image) VALUES 
...
(9,"Virginia Woolf", "Adeline Virginia Stephen más conocida como Virginia Woolf fue una escritora británica, autora de novelas, cuentos, obras teatrales y demás obras literarias; considerada una de las más destacadas figuras del vanguardista modernismo anglosajón del siglo XX y del feminismo internacional.", "VIRGINIA-WOOLF.jpg"),
...
(11,"Santiago Bilinkis","Santiago Bilinkis es emprendedor y tecnólogo. Egresado del Colegio Nacional de Buenos Aires, estudió luego Economía en la Universidad de San Andrés, donde se graduó con Medalla de Oro. En 2010 fue seleccionado para asistir a Singularity University en una sede de la NASA en Silicon Valley, donde estudió junto a los más destacados científicos del mundo sobre Inteligencia Artificial, Robótica, Biotecnología, Neurociencia y Nanotecnología.","SANTIAGO-BILINKIS.jpg"),
(12,"Santiago Campanario","Santiago Campanario nació en La Plata en 1973. Es licenciado en Economía por la UBA y estudió Periodismo en TEA. Su carrera profesional comenzó en el semanario El Economista en 1994, más tarde ingresó a Clarín, y escribe actualmente en La Nación sobre innovación, creatividad y economía no convencional","SANTIAGO-CAMPANARIO.jpg"),
(13,"Luciano Galup","Cursó la Maestría Interdisciplinaria en Estudios sobre Servicios de Comunicación Audiovisual (UBA). Diplomado por el Instituto Tecnológico de Buenos Aires (ITBA) en Big Data, se especializa en medios sociales, comunicación política y análisis de datos. Desde 2011 dirige la agencia digital Menta Comunicación de Argentina.","LUCIANO-GALUP.jpg"),
(14,"Walter Sosa Escudero","Walter Sosa Escudero nació en Buenos Aires en 1965. Obtuvo su licenciatura en Economía en la Universidad de Buenos Aires y su PhD en la Universidad de Illinois, en Urbana-Champaign. Se especializa en econometria teórica y aplicada a cuestiones sociales, como la medición de la pobreza y la desigualdad. Es autor de numerosos libros y artículos científicos, que incluyen avances teóricos de frontera, material para la docencia, notas de divulgación e informes de consultoría.","WALTER-SOSA-ESCUDERO.jpg"),
(15,"Caroline Criado Perez","Caroline Criado-Perez es una periodista freelance británica, escritora, activista y consultora. Con sus diferentes campañas ha conseguido que el Banco de Inglaterra incluyera la cara de Jane Austen en los billetes de 10 libras desde 2017 y que Twitter cambiara su política de denuncia por acoso a los mujeres. En 2013 fue elegida por la BBC para su programa 100 Women, una serie multiformato que analiza el papel de la mujer en el siglo XXI. En 2015 fue nombrada Oficial de la Orden del Imperio Británico por sus servicios a la igualdad y la diversidad, especialmente en los medios de comunicación. Como escritora, ha publicado el ensayo Do It Like a Woman en 2015.","CAROLINE-CRIADO-PEREZ.jpg");
...
(34, "El lado oscuro de la econometria"," El estilo es a veces provocador, y busca, ojalá que en forma honesta, que los practicantes reflexionen sobre el uso de distintas herramientas econométricas y se vean incentivados a razonar más que a seguir modas pasajeras. Contenido: Capítulo 1: Los Reyes Magos son los padres (Criticar la econometría). Capítulo 2: El paper de un solo número (Comunicar y leer la econometría). Capítulo 3: Esto no es una pipa (Pensar la econometría). Capítulo 4: Como el vals (Enseñar y aprender econometría). Capítulo 5: ¿Otra vez arroz? (Aplicar la econometría)",489,3,9789876299268,200,"EL-LADO-OSCURO-DE-LA-ECONOMETRIA.jpg",null,4,null,14,15,1,1),
(35,"Pasaje al futuro","No existe una sola actividad humana que no vaya a verse alterada por las innovaciones que ya se están desarrollando. Y si actualmente sentimos que las cosas cambian rápido, hay que prepararse para una nueva acelerada. El desafío de adaptación que enfrentaremos será enorme e impactará directamente en las decisiones cotidianas. En este escenario: ¿Qué tipo de educación darle a nuestros hijos? ¿Tendrá sentido escoger una carrera universitaria? ¿Cómo prepararnos y preparar a nuestras organizaciones para el mundo que viene?",449,3,9789500763301,200,"PASAJE-AL-FUTURO.jpg",null,4,2,11,14,1,1),
(36,"Modo Esponja","¿Qué hacer para no marearse en la tormenta de información sobre los actuales avances exponenciales en ciencia y tecnología? ¿Qué estrategias conviene aplicar, a nivel personal, en un contexto de cambio acelerado y de incertidumbre extrema como el que vivimos?",449,3,9789500763080,200,"MODO-ESPONJA.jpg",10,4,null,12,14,1,1),
(37,"Ideas en la ducha","¿Cómo surgen las mejores ideas? ¿Es posible que un buen baño de agua caliente, caminatas largas, reírnos, meditar, soñar despiertos en un café, dibujar lo que pensamos y hasta hacer malabares nos lleven a ser más creativos? Los más recientes avances científicos sugieren que sí, y este libro repasa, en forma entretenida y con un lenguaje sencillo, las últimas técnicas para lograr explosiones de creatividad.",449,3,9789500763080,200,"IDEAS-EN-LA-DUCHA.jpg",10,4,null,12,14,1,1),
(38,"Guía para sobrevivir al presente","Santiago Bilinkis aborda en su nuevo libro un tema central del presente: cómo esa supercomputadora de bolsillo que es el teléfono celular está afectando nuestras vidas. El impacto de las nuevas tecnologías sobre el cerebro, la educación, el trabajo y el uso del tiempo libre, bajo la mirada del autor de Pasaje al futuro",449,3,9789500763301,200,"GUIA-PARA-SOBREVIVIR-AL-PRESENTE.jpg",null,4,2,11,14,1,1),
(39,"Revolución Senior","Sebastián Campanario cuenta de qué modo los +45 tendrán un lugar protagónico en los próximos años. Una propuesta original y disruptiva, que da las claves para deconstruir nuestros prejuicios por edad hacia las personas mayores y entender los huracanes de cambio que estamos atravesando. ¿Solo los jóvenes son creativos e innovadores? ¿Qué podrían hacer las empresas y los gobiernos para dejar de ver los años como un problema y aprovechar su potencial económico? ¿A qué edad, realmente, uno considera que los demás son viejos? Así como sucedió con el debate de género, crece la conciencia sobre el estigma de valores negativos atribuidos a la vida adulta.",449,3,9789500763080,200,"REVOLUCION-SENIOR.jpg",10,4,null,12,14,1,1),
(40,"Big Data y política","El primer libro de uno de los analistas de marketing y consultoría con mayor proyección de los últimos años; un análisis pormenorizado de cómo la información se ha convertido en uno de los bienes más valiosos y las redes sociales en el medio esencial para la comunicación política en lo que va del siglo XXI. ",449,3,9789877800692,200,"BIG-DATA-Y-POLITICA.jpg",null,4,2,13,14,1,1),
(41,"Big Data","Cada vez que deslizamos nuestros dedos por una pantalla e ingresamos a una página web para hacer una compra o buscar una dirección, cada vez que hacemos un posteo, damos un like o subimos una foto a las redes sociales, cada vez que usamos la tarjeta de crédito, el GPS, cada vez que… estamos generando datos, ¡cantidades espeluznantes de datos espontáneos! (de hecho, en los últimos dos años la humanidad produjo más datos que en toda su historia previa).",489,3,9789876299268,200,"BIG-DATA.jpg",null,4,null,14,15,1,1),
(42,"La mujer invisible","¿Te imaginas cómo sería vivir en un mundo en el que tu teléfono móvil es demasiado grande para tu mano? ¿En el que tienes un 47 % más de probabilidades de morir que tu pareja en caso de sufrir un accidente? ¿En el que un fármaco prescrito por el médico produce efectos secundarios en tu organismo?",259,3,9788432236235,200,"LA-MUJER-INVISIBLE.jpg",null,4,2,15,15,1,1);
